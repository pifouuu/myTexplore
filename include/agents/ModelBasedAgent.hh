...
public:
  ...
  virtual int first_action(const std::vector<float> &s, float* avg_explo_prop, float* avg_reward_prop, float* avg_sync_prop);
  virtual int next_action(float r, const std::vector<float> &s, float* avg_explo_prop, float* avg_reward_prop, float* avg_sync_prop);
...
protected:
  ...
  int chooseAction(const std::vector<float> &s, float* avg_explo_prop, float* avg_reward_prop, float* avg_sync_prop);
